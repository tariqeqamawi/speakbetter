...
- **Pace: 1.43×** playback with pitch preserved. Gemini takes pace in a direction loosely, so the exact part is the player's — the gravel stays where it is, the delivery is brisk and conversational.
