...
- The lesson player's on-screen cues: a short phrase naming what the teacher is talking about, lifted from the captions and timed to the second he says it, every five to ten seconds — with a few arriving as icons where a drawing says it faster. Generated by a build step from the lessons' own transcripts (§03) — *built*
