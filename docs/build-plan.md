...
- The coach's voice: Gemini text-to-speech in one of thirty stock voices, directed in words ("warm and unhurried, like a coach who's on your side"); an audition page at `/prototype/voice` plays a real line in each through the lion and sets the app's voice; the coach pop-in's "Hear it" uses it — *built; the teacher's own cloned voice is a later swap behind the same function*
