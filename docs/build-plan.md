...
- The lesson player's on-screen cues: one complete thought from what the teacher is saying, lifted whole from the captions and timed to the second he says it, about every ten seconds — with a few arriving as icons where a drawing says it faster, and a fresh deal of runners-up on every play-through. Generated by a build step from the lessons' own transcripts (§03) — *built*
...
- The coach's voice: Gemini text-to-speech in one of thirty stock voices, directed in words; an audition page at `/prototype/voice` plays a real line in each through the lion and sets the app's voice; the coach pop-in's "Hear it" uses it — *built and settled (2026-09-18): Charon, British, a low even gravelly baritone, at 1.43× with pitch preserved; the lion's mouth holds for a beat of two syllables per open, with motion-interpolated in-betweens and frame blending — see master plan §14 "The lion speaks"; the teacher's own cloned voice is a later swap behind the same function*
...
- The before-and-after reel: thirty seconds cut on the phone from the baseline and the latest attempt, shared to socials from the share sheet or with the other students as scores and spectra (§13, §12) — *built*
