...
const MOMENTS: Moment[] = [
  ...
  {
    image: "/origin/v3/first-speech.webp",
  ...
  {
    image: "/origin/v3/for-others.webp",
  ...
  {
    image: "/origin/v3/coach-roar.webp",
    year: "Now",
