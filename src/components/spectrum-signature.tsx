...
// one continuous wave whose peaks sit over the colours they belong to,
// bleeding into each other where they meet. Speaking isn't seven
// separate meters — the colours run together in a talk, and the graph
// should say so. The hard numbers underneath are what make it readable.

/** Below this share, a colour is a trace rather than a presence. */
const MEANINGFUL = 5;
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-navy-600 bg-navy-800">
        ...
        <div className="flex flex-1 flex-col gap-3 p-5">
          ...
          <p className="text-sm text-ink-muted">
            ...
            mix of colours your speaking carries.
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-navy-600 bg-navy-800">
      ...
      <div className="flex flex-1 flex-col gap-4 p-5">
        <div className="relative overflow-hidden rounded-xl bg-navy-950/70 p-4">
          ...
          >
            <defs>
              {/* Each peak sits over its own colour, and the stops bleed
            ...
            {/* Bleed: a heavily blurred copy under everything, so colour
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <CategoryIcon
                    category={cat.id}
                    className={`size-4 ${percent >= MEANINGFUL ? cat.textClass : "text-ink-faint"}`}
                  />
                </li>
              );
            })}
        ...
        {/* A colour scraping 1% isn't "present" in any way a listener would
