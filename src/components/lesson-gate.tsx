  ...
  if (onTrial(state) && !trialAllowsLesson(vimeoId))
    return (
      <UpgradePanel
        ...
        body="The free baseline includes the lessons your baseline challenges lean on. All eighty-one - the seven colors, the deck, every challenge - come with Starter: one payment, six weeks of access."
      />
    );
  return <>{children}</>;
}
